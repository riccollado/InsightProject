...
from generator_distribution import generate_geometric
from generator_distribution import generate_PERT
...
if __name__ == "__main__":
   ...
   no_of_layers = 5
   density = 0.4
   problem['network'], problem['network_figure'], problem['network_pos'] = \
   ...
   penalty['m'] = 15.0
   penalty['b1'] = 21.0
   penalty['t_init'], penalty['t_final'] = generate_penalty_bounds(problem['network'], problem['PERT'])
